...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('dizel.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            ...
                            <select name="category_id" id="category_id" class="form-control">
                                ...
                                <option value="{{ $categoriy->id }}">{{ $categoriy->title_ru }} |Parent: {{ $categoriy->parent->title_ru }}</option>
                                @endforeach
                            </select> --}}
                            <label>Select a category</label>
                            <select name="categoriy_id" id="categoriy_id" class="form-control">
                                @foreach ($categoriys as $categoriy)
                                    <option value="{{ $categoriy->id }}">{{ $categoriy->title_ru }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_uz" class="editor" id="content_uz" cols="30" rows="10"></textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_ru" class="editor" id="content_ru" cols="30" rows="10"></textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_en" class="editor" id="content_en" cols="30" rows="10"></textarea>
