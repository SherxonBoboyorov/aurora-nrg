                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_uz" class="editor" id="content_uz" cols="30" rows="10">{!! $page->content_uz !!}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_ru" class="editor" id="content_ru" cols="30" rows="10">{!! $page->content_ru !!}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_en" class="editor" id="content_en" cols="30" rows="10">{{ $page->content_en }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_ru" class="form-control" id="meta_title_ru" cols="30" rows="10">{{ $page->meta_title_ru }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_ru" class="form-control" id="meta_description_ru" cols="30" rows="10">{{ $page->meta_description_ru }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_uz" class="form-control" id="meta_title_uz" cols="30" rows="10">{{ $page->meta_title_uz }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_uz" class="form-control" id="meta_description_uz" cols="30" rows="10">{{ $page->meta_description_uz }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_title_en" class="form-control" id="meta_title_en" cols="30" rows="10">{{ $page->meta_title_en }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="meta_description_en" class="form-control" id="meta_description_en" cols="30" rows="10">{{ $page->meta_description_en }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-6">
                            <div name="file">{{ asset($page->video) }}</div>
                      </div>
                    </div>
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
